  ...
  return (
    ...
    <div className={`pt-16 ${view}`}>
      <div className="px-10 py-10">
        ...
        <form action="" className="flex max-lg:flex-col px-14 py-9 items-start font-montserrat max-lg:gap-5 hover:border-blue-900 border justify-between rounded-lg">
          ...
          <div className="flex flex-col gap-10 border-l pl-4">
            ...
            <textarea placeholder="Type your message here" name="" id="" cols="30" rows="3" className="outline-blue-900 p-5 border hover:border-blue-900"></textarea>
